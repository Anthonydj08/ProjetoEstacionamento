...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo base_url('criarvaga'); ?>">Adicionar vaga</a>
        </div>
                            ...
                            <div class="row">
                                ...
                                foreach ($query->result() as $vaga) { ?>
                                    ...
                                    <?php if ($vaga->id_veiculo == 0) { ?>
                                        ...
                                        <div class="col-md-2" style="height: 136px;">
                                            <a href="<?php echo base_url('vagaEditar/' . $vaga->id_vaga) ?>">
                                                <img class="rounded mx-auto d-block" style="height: 60px;" src="/imagens/estacionaVerde.png" alt="Minha Figura" />
                                                <h5 class="text-center"><?php echo $vaga->numero; ?></h5>
                                            </a>
                                        </div>
                                    <?php } ?>
